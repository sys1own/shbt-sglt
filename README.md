...
* **LANR Power & $N-k$ Derating (`sglt-lanr-power`)**: 1,800-module LANR plant delivering $913.176\text{ kW}_{\text{net}}$ at $33.804\%$ TEG efficiency with $N+14$ reserve above the 1,786-module floor, register-mapped derating $\Delta N(k) = \lfloor \Delta P_{\text{net}} / P_{\text{bit}} \rfloor$, and focal baseline expansion $f_0 = 169.30\text{ m} \to f_{\max} = 1692.99\text{ m}$.
...
* **Ephemeris Astrodynamics & RL Autonomy (`sglt-orbital-flight`, `sglt-autonomy-comm`)**: Four-body CR3BP Prince–Dormand 8(7) (DOP853) integration with $|\Delta C_J| \le 10^{-12}$, fifth-order minimum-jerk trajectories, PPO/SAC deep-RL planning with NSGA-III Pareto optimization ($\mathcal{HV} \ge 0.998$), $12\text{ Gbps}$ 1550 nm optical downlink, and $32\text{ GHz}$ Ka-band backup at $150\text{ kbps}$.
...
| 10 | LANR power: net array output $P_{\text{net}}$ | $\ge 913.180\text{ kW}$ | $913.176\text{ kW}$ | PASS |
